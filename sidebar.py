...
#         "Faixa Etária", 
#         faixa_etaria_opcoes, 
#         default=faixa_etaria_opcoes[1:],
#         key="faixa_etaria"
#     )

#     # Garantir que "TODOS" exclua outras opções
...
#         faixa_etaria = ["TODOS"]  # Restringe a seleção a "TODOS" se ele for marcado
...
#         faixa_etaria = ["TODOS"]  # Reverte para "TODOS" se todas as opções forem desmarcadas
